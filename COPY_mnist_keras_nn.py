...
if __name__ == '__main__':
    ...
    model = Sequential([
        Dense(64, input_shape=(img_size * img_size,), activation='relu'),
        Dense(64, activation='relu'),
        Dense(10, activation='softmax'),
    ])

    model.summary(print_fn=lambda line: logger.info("XXXXX ->  " + line))
    ...
    # model_file_path = 'saved_models/mnist_keras_nn.h5'
